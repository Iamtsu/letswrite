...
- [x] **#30 P2.1b** Anthropic provider implementation — *blocked by #12*
- [x] **#13 P2.2** Right-column assistant panel — *blocked by #5, #30*
...
- [x] **#18 P3.1** Character overview & editor — *blocked by #8*
- [x] **#19 P3.2** Location overview & editor — *blocked by #18*
...
- [x] **#24 P3.7** Research / worldbuilding notes — *blocked by #7*
